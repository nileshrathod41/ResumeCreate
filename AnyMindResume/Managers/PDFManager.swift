...
//  PDFManager.swift
//
//  Created by AppCoda on 11/03/22.
//
...
class PDFManager: ObservableObject {
    ...
    static var preview: PDFManager {
        ...
        manager.skills = ["Multitasking", "English language", "Design", "Leadership", "Visionary"]
...
extension View {
    func exportToPDF(completion: @escaping (_ url: String?) -> Void) {
        let outputFileURL = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!.appendingPathComponent("AnyMindResume.pdf")
