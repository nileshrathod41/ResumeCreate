    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false, content: {
            ...
            VStack(alignment: .leading, spacing: 30) {
                ...
                Text("Add the most recent 1-2 companies that you've worked for").font(.system(size: 18)).bold()
    ...
    var body: some View {
        ScrollView(.vertical, showsIndicators: false, content: {
            ...
            VStack(alignment: .leading, spacing: 30) {
                ...
                VStack(spacing: 35) {
                    CustomTextField(text: $workModel.business, placeholderText: "Company Name")
